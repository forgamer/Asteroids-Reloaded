...
(function(){
	Asteroids.Main=function()
	{
		...
		e.onLoadCallback(function(){g.ready()});
	...
	Game.Scene,
	{
		...
		onRenderScene:function a(k)
		{
			if(this.imagesLoaded)
			{
				...
				k.restore();
				this.sineText(k,Game.Util.message("title"),GameHandler.width*0.5-130,GameHandler.height*0.5-64)
			}else{
		...
		sceneRendererWelcome:function i(j)
		{
			...
			k(j,!iOS?Game.Util.message("start"):"Touch to start!","18pt Arial",GameHandler.height*0.5);
			k=(BITMAPS?Game.fillText:Game.drawText);
			k(j,Game.Util.message("author"),"10pt Arial",16,624)
		},
		...
		sceneRendererInfo:function d(j)
		{
			...
			if(!iOS)
			{
				k(j,Game.Util.message("instruction1"),"14pt Arial",40,320);
				k(j,Game.Util.message("instruction2"),"14pt Arial",40,350);
				k(j,Game.Util.message("instruction3"),"14pt Arial",40,370);
				k(j,Game.Util.message("instruction4"),"14pt Arial",40,390);
				k(j,Game.Util.message("instruction5"),"14pt Arial",40,410);
				k(j,Game.Util.message("instruction6"),"14pt Arial",40,430)
			}else{
				k(j,Game.Util.message("instruction1"),"14pt Arial",40,320);
				k(j,"Touch in the left hand side of the screen and drag left/right to rotate.","14pt Arial",40,350);
				k(j,"Touch in the right hand side of the screen and drag up to thrust","14pt Arial",40,370);
				k(j,"and flick down for shield.","14pt Arial",40,390);
				k(j,Game.Util.message("instruction3"),"14pt Arial",40,410);
				k(j,Game.Util.message("instruction4"),"14pt Arial",40,430)
			}
		},
...
(function(){
	...
	extend(
		Asteroids.GameOverScene,Game.Scene,
		{
			game:null,
				...
				if(d.framecounter++===0)
				{
					if(this.game.score===this.game.highscore)
					{
						...
						try{
							if($)
							{
								var h=this.game.score;
								$("#results").html(Game.Util.message("new-high-score")+": "+h);
								var g="http://twitter.com/home/?status=I%20scored:%20"+h+"%20-%20in%20the%20Asteroids%20[Reloaded]%20HTML5%20game!%20Try%20your%20skillz...%20http://bit.ly/asteroids%20%23javascript%20%23html5";
								$("#tweetlink").attr("href",g);
...
(function(){
	...
	extend(
		Asteroids.GameCompleted,Game.Scene,
		{
			game:null,isComplete:function b()
			{
				return true
			},
			intervalRenderer:function a(d,c)
...
(function(){
	...
	extend(
		Asteroids.GameScene,Game.Scene,
		{
			game:null,
			wave:0,
			input:{left:false,right:false,thrust:false,shield:false,fireA:false,fireB:false},
			player:null,
			actors:null,
			playerBullets:null,
			enemies:null,
			...
			onTouchStartHandler:function onTouchStartHandler(event)
			{
				for(var i=0,t;i<event.changedTouches.length;i++)
				{
					...
					this.touches[t.identifier]={tx:t.screenX,ty:t.screenY,txd:t.screenX,tyd:t.screenY}
				}
				return true
			},
...
(function(){
	Asteroids.Prerenderer=function()
	{
		...
		this.addRenderer(
			function(c){return b.call(this,c,Asteroids.Colours.ENEMY_SHIP)},
		...
		this.addRenderer(
			function(c){return a.call(this,c,Asteroids.Colours.PARTICLE)},
			"smudges_"+Asteroids.Colours.PARTICLE
		);
		this.addRenderer(
			function(c){return a.call(this,c,Asteroids.Colours.ENEMY_SHIP)},
...
(function()
{
	...
	extend
	(
		Asteroids.Player,Game.SpriteActor,
		{
			...
			onRender:function k(l)
			{
				...
				if(this.shieldCounter>0&&this.energy>0)
				{
					if(BITMAPS)
					{
						...
						l.translate(this.position.x,this.position.y);
						l.rotate(o);
						l.shadowColor=l.strokeStyle=Asteroids.Colours.PLAYER_SHIELD;l.beginPath();
...
(function()
{
	Asteroids.Asteroid=function(g,d,f,e)
	{
		...
		this.rotationSpeed=(Rnd()-0.5)/30;return this
	};
	extend
	(
		Asteroids.Asteroid,
...
(function()
{
	...
	extend
	(
		Asteroids.EnemyShip,Game.EnemyActor,
		{
			SHIP_ANIM_LENGTH:90,
			RADIUS:16,
...
(function()
{
	...
	extend
	(
		Asteroids.PrimaryWeapon,Asteroids.Weapon,
		{
			doFire:function()
			{
...
(function()
{
	...
	(
		...
		Game.Actor,
		{
			...
			{
				var j=this.lifespan-(GameHandler.frameStart-this.bulletStart),g=i;
				if(j<h)
				{
					g=(i/h)*j;
					if(g<0)
...
function AsteroidsParticle(a,b,c,d,g,e,f)
{
	...
	{
		var k=this.lifespan-(GameHandler.frameStart-this.particleStart),h=j;
		if(k<i)
		{
			h=(j/i)*k;
			if(h<0)
...
(function()
{
	Asteroids.AsteroidExplosion=function(d,a,b)
	{
		...
		Asteroids.AsteroidExplosion.superclass.constructor.call
		(
			this,
			d,
			a,
...
(function()
{
	...
	{
		var b=(BITMAPS?12:3);
		Asteroids.PlayerExplosion.superclass.constructor.call
		(
			this,
			c,
			a,
...
(function()
{
	...
	{
		var c=(BITMAPS?8:6);
		Asteroids.EnemyExplosion.superclass.constructor.call
		(
			this,
			d,
			b,
...
(function()
{
	...
	(
		...
		Game.EffectActor,
		{
			...
			{
				var e=Floor(this.effectValue(255)),b=this.effectValue(this.size*8),d=e.toString();
				c.save();
				c.globalAlpha=0.75;
...
(function()
{
	...
	{
		Asteroids.PlayerBulletImpact.superclass.constructor.call
		(
			this,
			b,
			a,
...
(function()
{
	...
	{
		Asteroids.EnemyBulletImpact.superclass.constructor.call
		(
			this,
			b,
			a,
